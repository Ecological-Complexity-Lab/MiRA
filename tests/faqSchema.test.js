 ...
 *
 * compare.html carries the FAQ twice: once as visible <details> markup and once
...
const PAGE_PATH = resolve(dirname(fileURLToPath(import.meta.url)), '../compare.html')
...
describe('compare.html — FAQ structured data', () => {
